...
export const PLANS = {
  ...
  advanced: {
    ...
    stripePriceIdAnnual: process.env.STRIPE_ADVANCED_ANNUAL_PRICE_ID || process.env.STRIPE_ADVANCED_PRICE_ID_ANNUAL,
    features: [
      'Everything in Free',
      'Full hosted compression beyond 500 calls/month',
      'Usage history and estimated savings dashboard',
    ],
  },
};
